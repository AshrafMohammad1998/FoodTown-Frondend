      ...
      >
        <div className="grid grid-cols-1 gap-6">
          <div className="col-span-6 sm:col-span-3">
            <label htmlFor="full-name" className="text-lg font-semibold dark:text-white">
              Full Name
            </label>
            <input
          ...
          <div className="col-span-6 sm:col-span-3">
            <label htmlFor="email-address" className="text-lg font-semibold dark:text-white">
              Email Address
            </label>
            <input
          ...
          <div className="col-span-6">
            <label htmlFor="subject" className="text-lg font-semibold dark:text-white">
              Subject
            </label>
            <input
          ...
          <div className="col-span-6">
            <label htmlFor="message" className="text-lg font-semibold dark:text-white">
              Message
            </label>
            <textarea
