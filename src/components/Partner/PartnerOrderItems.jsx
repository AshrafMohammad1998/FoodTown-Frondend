...
function PartnerOrderItems({ order, fetchData }) {
  ...
  return (
    <li className="border border-slate-300 rounded-lg shadow-xl w-[90%] md:w-3/4 m-auto mt-4">
      <div className=" rounded-t-lg flex justify-between w-full bg-slate-200 text-black dark:text-slate-500 p-2 sm:p-4">
      ...
      <div className="flex justify-between p-2 sm:p-4">
        ...
        {<select value={order.status} onChange={handleStatusChange} disabled={order.status === "Delivered"} className="disabled:cursor-not-allowed text-black border border-slate-300">
