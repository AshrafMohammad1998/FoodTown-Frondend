...

{
  ...
  <input id="addingImage" className="hidden" type="file" />
  <div className="relative">
    <img
      src={"image1.jpeg"}
      className="h-36 w-36 rounded-xl disabled:cursor-not-allowed border border-red-500"
    />
    <p className="absolute -bottom-6 px-1 right-0 bg-black text-white border border-slate-500 rounded-lg transform -translate-y-full">
      Edit
    </p>
  </div>
</div>; */
